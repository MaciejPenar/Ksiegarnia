    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            .authorizeRequests()
                ...
                .antMatchers("/edit_zam/{id_zamowienia}").hasAuthority("ROLE_ADMIN")
                .antMatchers("/edit_pracownik/{id_pracownika}").hasAuthority("ROLE_ADMIN")
                .antMatchers("/edit_klient/{id_klienta}").hasAuthority("ROLE_ADMIN")
                .antMatchers("/edit_adres/{id_adresu}").hasAuthority("ROLE_ADMIN")
                .antMatchers("/edit_ksiazka/{id_ksiazki}").hasAuthority("ROLE_ADMIN")
