    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            .authorizeRequests()
                ...
                .antMatchers("/delete_ksiazka").hasAuthority("ROLE_ADMIN")
                .antMatchers("/delete_zam").hasAuthority("ROLE_ADMIN")
                .antMatchers("/delete_pracownik").hasAuthority("ROLE_ADMIN")
                .antMatchers("/delete_klient").hasAuthority("ROLE_ADMIN")
                .antMatchers("/delete_adres").hasAuthority("ROLE_ADMIN")
